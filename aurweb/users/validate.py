...
def invalid_suspend_permission(
    request: Request | None = None, user: models.User | None = None, S: str = "False", **kwargs
) -> None:
...
def invalid_username(
    request: Request | None = None, U: str = str(), _: l10n.Translator | None  = None, **kwargs
) -> None:
...
def invalid_ssh_pubkey(
    PK: str = str(), user: models.User | None = None, _: l10n.Translator | None = None, **kwargs
) -> None:
    if not PK:
        return
...
def username_in_use(
    U: str = str(), user: models.User | None  = None, _: l10n.Translator | None = None, **kwargs
) -> None:
    exists = (
...
def email_in_use(
    E: str = str(), user: models.User | None  = None, _: l10n.Translator | None = None, **kwargs
) -> None:
    exists = (
        db.query(models.User)
...
def invalid_captcha(captcha_salt: str | None = None, captcha: str | None = None, **kwargs) -> None:
